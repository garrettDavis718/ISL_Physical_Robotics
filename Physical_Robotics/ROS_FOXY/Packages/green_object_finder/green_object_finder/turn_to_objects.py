...
class WallAvoider(Node):
    ...
    def green_finder(self):
        """_summary_: This function looks at truncated image returned by the turtlebot's camera and determines
    ...
    def take_photo(self):
        """_summary_: THis function is called once the turtlebot has found the closest green object. It will take
...
def read_csv():
    """_summary_: This function will read the csv generated by closest_objects.py and add them to a list to be
    iterated over.
...
def write_csv(objects):
    """_summary_: This function will write a new csv with updated values for the is_green attribute of our objects.
